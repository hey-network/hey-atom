    ...
    rp(options).then(function(r) {
        ...
        if(r.success && r.result){
            ...
            atom.confirm({
              ...
              detailedMessage:"Here's the link to your question: https://ide.hey.network/p/"+r.result
            });
        }
        else {
...
export default {
  ...
  sayHey() {
    ...
    if (editor = atom.workspace.getActiveTextEditor()) {
      ...
      let _language = "";
      editor.observeGrammar(function(_grammar){
        if(_grammar && _grammar.languageModule && _grammar.languageModule.name){
          _language = _grammar.languageModule.name;
        }
      });
      PostQuestion("", _code, _language);
    }
  }
